...
namespace BookCurlPro
{
    ...
    public class BookPro : MonoBehaviour
    {
        ...
        public static event Action BookFlip;
        /// <summary>
        ...
        void Start()
        {
            ...
            Invoke("UpdatePages",0.5f);
            StartCoroutine(Wait(0.5f));          
            CalcCurlCriticalPoints();
            //AudioSource a = GameObject.Find("TextPanel p" + currentPaper + "s0").GetComponent<AudioSource>();
            //if (a != null)
            //{
            //    SentenceAudioController.instance.OnAudioSourceChanged += PlayCurrentSentence;
            //    SentenceAudioController.instance.PlayAudio(a);
            //    SentenceAudioController.instance.OnAudioSourceChanged -= PlayCurrentSentence;
            //}
            ...
            ClippingPlane.rectTransform.sizeDelta = new Vector2(pageWidth * 2 + pageHeight, pageHeight + pageHeight * 5);
        ...
        public void UpdatePages()
        {
            ...
            else
            {
                ...
                if (previousPaper >= 0)
                {
                    //BookUtility.ShowPage(papers[previousPaper].Back); change here
        ...
        public void DragRightPageToPoint(Vector3 point)
        {
            ...
            currentPaper += 1;
            PlayerPrefs.SetInt("Current Page", currentPaper);
            UpdatePages();
